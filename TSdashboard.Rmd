...
reactable::reactable(data = taylor.view,searchable = TRUE,
                     ...
                     ),highlight = TRUE, showPagination = FALSE,defaultPageSize = 144,bordered = TRUE,defaultColDef = colDef(align = "center",vAlign = "center")) %>% add_title("Table: Taylor Swift's Spotify Data: standard edition", align = "center", font_color = "blue")
```
